...
class RailNetwork:
    ...
    def _initialize_routes(self):
        ...
        self.resources[1].valid_routes[self.resources[1]] = [
            self.resources[2],
            self.resources[6],
        ]
        ...
        self.resources[4].valid_routes[self.resources[4]] = [
            self.resources[3],
            self.resources[7],
        ]
...
if __name__ == "__main__":
    ...
    agents = [
        TrainAgent(id=i, current_position=initial_position[i], policy=RandomPolicy())
        for i in range(2)
    ]
