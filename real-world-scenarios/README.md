...
| ![Track](img/elem-track-specifics.png) | Track specifics | Track with specific length, vmax, gradient... | railway
| ![Track](img/elem-switch.png) | Switch | Where agents can take directional decisions. | railway
| ![Track](img/elem-station.png) | Station | Where agents can start / stop their jurney. | railway
| ![Track](img/elem-signal.png) | Signal | Lets agents pass or halt. | railway
